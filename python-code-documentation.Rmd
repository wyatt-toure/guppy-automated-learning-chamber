...
<div class="topnav">
  <a href="index.html">Home</a>
   ...
   <a class="active" href="python-code-documentation.html">Python Code Documentation</a>
...
`datetime` is imported so that XYZ.

`pigpio` is imported for XYZ. 

`RPi.GPIO` is imported to XYZ. 

`random`is imported for XYZ. 
